...
② 권리자는 이용자가 공연권 구매 시 이용허락기간 동안 대상저작물을 공연하는 것을 허락한다. 이용허락기간은 구매일로부터 3개월이며, 공연 횟수는 각 공연권 구매 당 1회로 한정한다. 또한, 이용자는 플랫폼에 예상공연일자를 입력하고 그 일자에 공연하여야 하며, 변경은 플랫폼을 통하여 진행한다.
③ 이용자가 대본 구매 시, 권리자는 플랫폼이 3개월간 이용자에게 대상저작물을 제공하는 것을 허락한다. 이용자는 구매일로부터 3개월간 대본을 플랫폼에서 다운로드 할 수 있다.
...
export const REFUND_POLICY = ` 대본은 구매 후 청약철회가 불가합니다. 구매 시점부터 3개월간 자유롭게 다운로드 가능합니다.

공연권은 구매 후 2주 이내, 미 공연시에만 환불이 가능합니다. 2주가 지나지 않았더라도 공연이 이루어졌다면 환불이 불가합니다. 또한, 공연권 행사 기간은 구매일로부터 3개월 안에만 가능합니다. 3개월 이내 미공연 시 공연권의 행사가 불가하오니 유의하시기 바랍니다. `;
