        ...
        <div className="  flex flex-col gap-[35px]">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col border-[0.5px] rounded-[5px] h-[250px] ">
              <textarea className=" p-medeim-regular h-[203px] p-[20px] border-none box-border resize-none  rounded-[5px] focus:outline-none focus:ring-0 "></textarea>
              <span className="h-[47px] bg-[var(--purple10)] w-full flex flex-row justify-between  rounded-[5px] ">
                ...
                <span className="my-auto mr-[13px]">0 / 50자 이상</span>
              </span>
            </div>
          </div>
        </div>
